    ...
    <>
      <footer className="footer footer-center p-10 bg-base-200 text-base-content rounded">
        <nav className="grid grid-flow-col gap-4">
          ...
          <Link to="/appointments" className="link link-hover">Appointments</Link>
          {/* <Link to="/messages" className="link link-hover">Message</Link> */}
        </nav>
        <nav>
        ...
        <aside>
          <p>Copyright © {new Date().getFullYear()} - All right reserved by Pawsitive Care</p>
        </aside>
      </footer>
    </>
  )

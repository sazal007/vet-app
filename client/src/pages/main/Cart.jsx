          ...
          <div className="flex shadow-sm my-10">
            <div className="w-3/4 bg-white px-10 py-10">
                ...
                cartItems.length === 0 ? <p className="text-center mt-28">Cart is empty</p> : cartItems.map((item, index) => (
                  <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5" key={index}>
                    ...
                    <div className="flex justify-center w-1/5">
                      ...
                      <input type="text" className="mx-2 border text-center w-16" defaultValue={item.quantity} disabled />
              ...
              {/* <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                <div className="flex w-2/5">
                  <div className="w-20">
                    <img className="h-24" src="https://i.imgur.com/9y3Byw5.png" alt="adf" />
                  </div>
                  <div className="flex flex-col justify-between ml-4 flex-grow">
              ...
              <Link to="/shop" className="w-40 flex font-semibold text-sm mt-14 cursor-pointer">
